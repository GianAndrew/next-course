...
const Select = ({ multiple, value, onChange, options }: SelectProps) => {
	...
	return (
		<div onClick={() => setIsOpen((prev) => !prev)} tabIndex={0} className='w-full relative outline-none rounded-md flex items-center gap-5 p-5 border '>
			...
			>
				<input type='text' className='w-full py-2 px-4 border rounded-md' onClick={(e) => e.stopPropagation()} onChange={(e) => setSearch(e.target.value)} />
				{options
